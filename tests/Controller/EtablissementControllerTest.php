...
class EtablissementControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'etablissement[nombre_etudiant]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNombre_etudiant('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'etablissement[nombre_etudiant]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNombre_etudiant());
    }
